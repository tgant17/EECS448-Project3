 ...
 *
 ...
 class queen : public chessPieceInterface
 {
    ...
    public: 
        ...
        /**
        * @pre a board is created to put the queen on
        * @post sets row and column to starting position
        * @post determines if it will be a 'Q' or a 'q' based on which player it is 
        */
        queen(int row, int col, int player);


        /**
        * @pre a queen object is created 
        * @post a queen object is destroyed 
        */
        ~queen(); 
