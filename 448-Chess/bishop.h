 ...
 *
 ...
 class bishop : public chessPieceInterface
 {
    ...
    public: 
        ...
        /**
        * @pre a board is created to put the bishop on
        * @post sets row and column to starting position
        * @post determines if it will be a 'B' or a 'b' based on which player it is 
        */
        bishop(int row, int col, int player);
        
        /**
        * @pre a bishop object is created 
        * @post a bishop object is destroyed 
        */
        ~bishop(); 
