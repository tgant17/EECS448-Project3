 ...
 *
 ...
 class king : public chessPieceInterface
 {
    ...
    public: 
        /**
        * @pre a board is created to put the king on
        * @post sets row and column to starting position
        * @post determines if it will be a 'K' or a 'k' based on which player it is 
        */
        king(int row, int col, int player);

        /**
        * @pre a king object is created 
        * @post a king object is destroyed 
        */
        ~king(); 
